...
const Description = () => {
  ...
  return (
    <>
      {t(
        'Choose a quota you want be assosiated with this cluster template. You can manage the existing quotas in the ',
      )}
      <InlineResourceLink
      ...
      />
      <br />
      {t(' Quotas can also be set and changed after the cluster template has been added.')}
    </>
  );
};
